...
#undef NEON_MAPPED_BUFFER_FUNC
    ...
    CookedLayout::ElementView::ElementView(const Element* Element) :
        m_Element(Element)
    {
    }

    auto CookedLayout::ElementView::operator[](const std::string& Name) const -> ElementView
    {
    ...
    CookedLayout::CookedLayout(bool GPULayout, size_t Alignement, const RawLayout::Element& LayoutElement)
    {
        Element::ProcessElement(GPULayout, m_CookedLayout, LayoutElement, m_Size, Alignement);
    }

    auto CookedLayout::operator[](const std::string& Name) const -> ElementView
    {

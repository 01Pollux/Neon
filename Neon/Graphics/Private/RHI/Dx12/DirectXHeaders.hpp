...
struct CD3DX12_COMPUTE_PIPELINE_STATE_DESC : public D3D12_COMPUTE_PIPELINE_STATE_DESC
{
    CD3DX12_COMPUTE_PIPELINE_STATE_DESC() :
        D3D12_COMPUTE_PIPELINE_STATE_DESC({})
    {
    }

    explicit CD3DX12_COMPUTE_PIPELINE_STATE_DESC(const D3D12_COMPUTE_PIPELINE_STATE_DESC& o) :
        D3D12_COMPUTE_PIPELINE_STATE_DESC(o)
    {
    }

    explicit CD3DX12_COMPUTE_PIPELINE_STATE_DESC(CD3DX12_DEFAULT) :
        D3D12_COMPUTE_PIPELINE_STATE_DESC({})
    {
    }
};